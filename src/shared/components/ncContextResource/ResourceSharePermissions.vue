...
<template>
	<div>
		<div>
			{{ t('tablespro', 'Shared resources permissions') }}
		</div>
		...
		<div v-else>
			{{ t('tablespro', 'No shared resources') }}
		</div>
	</div>
</template>
